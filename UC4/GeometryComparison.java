...
public class GeometryComparison extends LengthCal{
	...
	public static void main(String[] args) {
		...
		{
			System.out.println("Length of Line1 is more than Line2");		
		}
		else if(Line1length<Line2length)
		{
		...
		String Line1=Double.toString(Line1length);	
		String Line2=Double.toString(Line2length);
	
		System.out.println("This is a Result of 'compareTo' Method : "+Line1.compareTo(Line2));
        ...
        // Creating object of Equals class		
		Equals eql=new Equals();
		
		// Calling equal method of Equals class and passing length of lines as parameter 
		// It returns true if length is same and if length is not same it return false
		System.out.println("This is a Result of 'equal' Method : "+eql.equal(Line1length, Line2length));
		if(eql.equal(Line1length, Line2length))
		{
			System.out.println("Both lines are of same length");
		}
